...
function bold_timeline_map_group() {
	...
	Bold_Timeline::$builder->map( 'bold_timeline_group', array( 'name' => esc_html__( 'Timeline Group', 'bold-timeline' ), 'description' => esc_html__( 'Timeline group', 'bold-timeline' ), 'container' => 'vertical', 'toggle' => true, 'icon' => 'bt_bb_icon_bold_timeline_group', 
