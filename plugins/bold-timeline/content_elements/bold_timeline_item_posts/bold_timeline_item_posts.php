...
function bold_timeline_item_posts() {
	...
	Bold_Timeline::$builder->map( 'bold_timeline_item_posts', 
		array( 
			'name' => esc_html__( 'Timeline Item Posts', 'bold-timeline' ), 'description' => esc_html__( 'Timeline Item Posts filter element', 'bold-timeline' ), 'icon' => 'bold_timeline_item_posts_icon', 'show_settings_on_create' => true, 'params' => array(
