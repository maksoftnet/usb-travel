...
function bold_timeline_item_separator() {
	...
	Bold_Timeline::$builder->map( 'bold_timeline_item_separator', array( 'name' => esc_html__( 'Separator', 'bold-builder' ), 'description' => esc_html__( 'Separator element', 'bold-builder' ), 'icon' => 'bold_timeline_item_separator_icon', 'params' => array(), 'show_settings_on_create' => true, 'params' => array(
