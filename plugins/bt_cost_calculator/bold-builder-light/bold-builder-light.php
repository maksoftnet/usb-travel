	...
	class BTBB_Light {
		...
		function translate() {
			...
			echo '<script>';
				...
				echo 'window.bt_bb_text.edit_layout = "' . esc_html__( 'Edit Layout', 'boldthemes_framework_textdomain' ) . '";';
		...
		function admin_edit_page() {
			...
			<form method="post" action="<?php echo esc_url( add_query_arg( array( 'post' => $post_id ), menu_page_url( $this->slug, false ) ) ); ?>">
				...
				<li class="bt-bb-light-home-page"><a href="<?php echo esc_url_raw( $this->home_url ); ?>" target="_blank"><?php esc_html_e( 'Home page', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php
				if ( current_user_can( 'activate_plugins' ) && $this->product_id != '' ) { ?>
					<li class="bt-bb-light-licence"><a href="<?php echo esc_url_raw( admin_url( 'admin.php?page=' . $this->license_slug ) ); ?>" target="_blank"><?php esc_html_e( 'Product License', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php }
				if ( $this->doc_url != '' ) { ?>
					<li class="bt-bb-light-documentation"><a href="<?php echo esc_url_raw( $this->doc_url ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php }
				if ( $this->support_url != '' ) { ?>
					<li class="bt-bb-light-support"><a href="<?php echo esc_url_raw( $this->support_url ); ?>" target="_blank"><?php esc_html_e( 'Support', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php } ?>
					<li class="bt-bb-light-revisions"><a href="<?php echo wp_get_post_revisions_url( $post_id ); ?>" target="_blank"><?php esc_html_e( 'Revisions', 'boldthemes_framework_textdomain' ); ?></a></li>
				</ul>
				</div>
				</div><!-- #informationdiv -->
