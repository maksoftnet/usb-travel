			...
			<?php
				...
				if ( is_array( $files ) && count( $files ) > 0 ) { ?>
					...
					<table class="form-table bt_wordpress_importer">
						...
						<tr>
							<td id="bt_import_disable_image_processing_container"><input type="checkbox" id="bt_disable_image_processing"><label for="bt_disable_image_processing"><?php _e( 'Disable image processing', 'bt_wordpress_importer' ); ?></label><br><p class="description"><?php _e( 'Faster and more reliable but requires post-processing with <a href="https://wordpress.org/plugins/regenerate-thumbnails/" target="_blank">Regenerate Thumbnails</a> plugin.', 'bt_wordpress_importer' ); ?></p></td>
						</tr>
						<tr>
