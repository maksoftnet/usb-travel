...
if ( ! function_exists( 'boldthemes_get_query_items' ) ) {
	function boldthemes_get_query_items( $params = array() ) {
            ...
            // search tags
            $search_tags            = isset($params['search_tags']) && !empty($params["search_tags"]) ? $params['search_tags'] : array();
            ...
            if ( !empty($search_categories) && !empty($search_destination) && !empty($search_tags)){
                $TxQuery = array(
                        'relation' => 'AND',
                        $TxQuery_categories,
            ...
            }else if(!empty($search_categories) && !empty($search_destination)){
                $TxQuery = array(
                        'relation' => 'AND',
                        $TxQuery_categories,
                        $TxQuery_destinations,
                );
            }else if(!empty($search_categories) && !empty($search_tags)){
                $TxQuery = array(
                        'relation' => 'AND',
                        $TxQuery_categories,
                        $TxQuery_tags,
                );
            }else if(!empty($search_tags) && !empty($search_destination)){
                $TxQuery = array(
                        'relation' => 'AND',
                        $TxQuery_destinations,
                        $TxQuery_tags,
