...
class bt_bb_progress_bar_advanced extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Advanced Progress bar', 'travelicious' ), 'description' => esc_html__( 'Advanced Progress bar', 'travelicious' ), 'container' => 'vertical', 'accept' => false, 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'type', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress Bar Type', 'travelicious' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Semi circle', 'travelicious' ) => 'semi-circle',
						esc_html__( 'Circle', 'travelicious' ) => 'circle'
					)
				),
				array( 'param_name' => 'percentage', 'type' => 'textfield', 'heading' => esc_html__( 'Percentage', 'travelicious' ), 'preview' => true ),
				array( 'param_name' => 'duration', 'type' => 'textfield', 'heading' => esc_html__( 'Animation duration', 'travelicious' ), 'preview' => true ),
						array( 'param_name' => 'easing', 'type' => 'dropdown', 'heading' => esc_html__( 'Easing', 'travelicious' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Linear', 'travelicious' ) => 'linear',
						esc_html__( 'Ease In Out', 'travelicious' ) => 'easeInOut',
						esc_html__( 'Bounce', 'travelicious' ) => 'bounce'
					)
				),
				array( 'param_name' => 'text', 'type' => 'textfield', 'heading' => esc_html__( 'Text below the icon or percentage', 'travelicious' ), 'preview' => true ),				
				array( 'param_name' => 'icon', 'type' => 'iconpicker', 'heading' => esc_html__( 'Icon', 'travelicious' ), 'preview' => true ),
				array( 'param_name' => 'url', 'type' => 'textfield', 'heading' => esc_html__( 'URL', 'travelicious' ) ),
				array( 'param_name' => 'target', 'type' => 'dropdown', 'heading' => esc_html__( 'URL Target', 'travelicious' ),
					'value' => array(
						esc_html__( 'Self (open in same tab)', 'travelicious' ) => '_self',
						esc_html__( 'Blank (open in new tab)', 'travelicious' ) => '_blank',
					)
				),
				array( 'param_name' => 'size', 'type' => 'dropdown', 'heading' => esc_html__( 'Size', 'travelicious' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Normal', 'travelicious' ) => 'normal',
						esc_html__( 'Small', 'travelicious' ) => 'small',
						esc_html__( 'Medium', 'travelicious' ) => 'medium',
						esc_html__( 'Large', 'travelicious' ) => 'large',
						esc_html__( 'Extra large', 'travelicious' ) => 'xlarge'
					)
				),
				array( 'param_name' => 'thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar thickness', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ),
					'value' => array(
						esc_html__( 'Small', 'travelicious' ) => 'small',
						esc_html__( 'Normal', 'travelicious' ) => 'normal',
						esc_html__( 'Medium', 'travelicious' ) => 'medium',
				...
				array( 'param_name' => 'trail_thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar trail thickness', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ),
					'value' => array(
						esc_html__( 'Same as progress bar', 'travelicious' ) => 'progressbar',
						esc_html__( 'Small', 'travelicious' ) => 'small',
						esc_html__( 'Normal', 'travelicious' ) => 'normal',
						esc_html__( 'Medium', 'travelicious' ) => 'medium',
						esc_html__( 'Large', 'travelicious' ) => 'large',
				...
				array( 'param_name' => 'color_from', 'type' => 'colorpicker', 'heading' => esc_html__( 'Starting Progress Bar Background color', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ) ),
				array( 'param_name' => 'color_to', 'type' => 'colorpicker', 'heading' => esc_html__( 'Ending Progress Bar Background color', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ) ),
				array( 'param_name' => 'text_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Text color', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ) ),
				array( 'param_name' => 'trail_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Color for lighter trail stroke underneath the actual progress path', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ) ),
				array( 'param_name' => 'fill_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Fill color', 'travelicious' ), 'group' => esc_html__( 'Design', 'travelicious' ) )						
			)
		) );
	}
}
