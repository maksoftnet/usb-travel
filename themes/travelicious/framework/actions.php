...
if ( ! function_exists( 'boldthemes_theme_init' ) ) {
	function boldthemes_theme_init() {  
		...
		load_theme_textdomain( 'travelicious', get_parent_theme_file_path( 'languages' ) );
...
if ( ! function_exists( 'boldthemes_widgets_init' ) ) {
	function boldthemes_widgets_init() {
		register_sidebar( array (
			'name' 			=> esc_html__( 'Sidebar', 'travelicious' ),
			'id' 			=> 'primary_widget_area',
			'description'   => esc_html__( 'Main sidebar', 'travelicious' ),
