...
BoldThemes_Customize_Default::$data['tour_headline_show_excerpt']	= false;
...
// Tour SINGLE LIST HEADER SHOW EXCERPT
if ( ! function_exists( 'boldthemes_customize_tour_headline_show_excerpt' ) ) {
	function boldthemes_customize_tour_headline_show_excerpt( $wp_customize ) {
		
		$wp_customize->add_setting( BoldThemesFramework::$pfx . '_theme_options[tour_headline_show_excerpt]', array(
			'default'           => BoldThemes_Customize_Default::$data['tour_headline_show_excerpt'],
			'type'              => 'option',
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'boldthemes_sanitize_checkbox'
		));
		$wp_customize->add_control( 'tour_headline_show_excerpt', array(
			'label'    => esc_html__( 'Show excerpt on single tour headline', 'travelicious' ),
			'section'  => BoldThemesFramework::$pfx . '_tour_section',
			'settings' => BoldThemesFramework::$pfx . '_theme_options[tour_headline_show_excerpt]',
			'priority' => 21,
			'type'     => 'checkbox'
		));
	}
}
add_action( 'customize_register', 'boldthemes_customize_tour_headline_show_excerpt' );
add_action( 'boldthemes_customize_register', 'boldthemes_customize_tour_headline_show_excerpt' );
...
function travelicious_bt_bb_fe( $elements ) {

	$elements[ 'bt_bb_tour_list' ] = array(
		'edit_box_selector' => '',
		'params' => array(
			'view_type'     => array(),
			'tour'          => array(),
...
add_filter( 'bt_bb_fe_elements', 'travelicious_bt_bb_fe' );
